    ...
    return SafeArea(
      child: Scaffold(
        bottomNavigationBar: GestureDetector(
          onTap: () {
            if (userInformationController.fullnamecontroller.text.isEmpty ||
                userInformationController.emailcontroller.text.isEmpty ||
                userInformationController.uniIDcontroller.text.isEmpty ||
                userInformationController.unicontroller.text.isEmpty ||
                userInformationController.coursecontroller.text.isEmpty) {
              CommonWidgets().toast(
